<footer class="footer-wrapper footer-layout1">
                    ...
                    <div class="row gy-4 align-items-center">
                        ...
                        <div class="col-lg-7">
                            <form class="newsletter-form"><input class="form-control" type="email"
                                    ...
                                    class="th-btn style3">Subscribe Now <img src="assets1/img/icon/plane.svg"
                                        alt=""></button></form>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="widget footer-widget">
                        <div class="th-widget-about">
                            <div class="about-logo"><a href="home-travel.html"><img src="./images/AtlasGo_Footer.png"
                                        alt="Tourm"></a></div>
                            ...
                            <div class="info-box_text">
                                ...
                                <div class="details">
                                    <p><a href="mailto:mailinfo00@tourm.com"
                                            class="info-box_link">atlasgo@gmail.com</a></p>
                                    <p><a href="mailto:support24@tourm.com"
                                            class="info-box_link">supportatlasgo24@gmail.com</a></p>
                                </div>
                            </div>
                            <div class="info-box_text">
                ...
                <div class="col-md-6 col-xl-auto">
                    <div class="widget footer-widget">
                        ...
                        <div class="sidebar-gallery">
                            <div class="gallery-thumb"><img src="assets1/img/widget/gallery_1_1.jpg"
                                    alt="Gallery Image"> <a target="_blank" href="https://www.instagram.com/"
                                    class="gallery-btn"><i class="fab fa-instagram"></i></a></div>
                            <div class="gallery-thumb"><img src="assets1/img/widget/gallery_1_2.jpg"
                                    alt="Gallery Image"> <a target="_blank" href="https://www.instagram.com/"
                                    class="gallery-btn"><i class="fab fa-instagram"></i></a></div>
                            <div class="gallery-thumb"><img src="assets1/img/widget/gallery_1_3.jpg"
                                    alt="Gallery Image"> <a target="_blank" href="https://www.instagram.com/"
                                    class="gallery-btn"><i class="fab fa-instagram"></i></a></div>
                            <div class="gallery-thumb"><img src="assets1/img/widget/gallery_1_4.jpg"
                                    alt="Gallery Image"> <a target="_blank" href="https://www.instagram.com/"
                                    class="gallery-btn"><i class="fab fa-instagram"></i></a></div>
                            <div class="gallery-thumb"><img src="assets1/img/widget/gallery_1_5.jpg"
                                    alt="Gallery Image"> <a target="_blank" href="https://www.instagram.com/"
                                    class="gallery-btn"><i class="fab fa-instagram"></i></a></div>
                            <div class="gallery-thumb"><img src="assets1/img/widget/gallery_1_6.jpg"
                                    alt="Gallery Image"> <a target="_blank" href="https://www.instagram.com/"
                                    class="gallery-btn"><i class="fab fa-instagram"></i></a></div>
                        </div>
                    </div>
    ...
    <div class="copyright-wrap" data-bg-src="assets1/img/bg/copyright_bg_1.jpg">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6">
                    <p class="copyright-text">Copyright 2024 <a href="home.php">AtlasGo</a>. All Rights
                        Reserved.</p>
                </div>
                <div class="col-md-6 text-end d-none d-md-block">
                    <div class="footer-card"><span class="title">We Accept</span> <img
                            src="assets1/img/shape/cards.png" alt=""></div>
                </div>
            </div>
        </div>
    </div>
...
<script src="assets1/js/circle-progress.js"></script>
