...
$user = array();
if ($tag == 1) {
    $query = "SELECT * FROM `tbl_package` WHERE `type` LIKE 'Domestic'";
    ...
    $query = "SELECT * FROM `tbl_package` WHERE `type` LIKE 'International'";
    $res = mysqli_query($con, $query);
                                        ...
                                        <div class="pkgc-face pkgc-back">
                                            ...
                                            <div class="pkgc-stub">
                                                ...
                                                <div class="pkgc-actions">
                                                    <a href="package_info.php?id=<?php echo $u['pid']; ?>" class="pkgc-btn-edit"> More Info </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
